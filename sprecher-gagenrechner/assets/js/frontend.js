(function () {
	...
	function updateGuidanceSummary(app, formData, ui) {
		...
		if (rightsNode) {
			rightsNode.innerHTML = '<strong>Rechte auf einen Blick</strong><p>' + htmlEscape(rightsParts.length ? rightsParts.join(' · ') : 'Sobald Projekt und Variante gewählt sind, fassen wir hier Gebiet, Laufzeit, Medien und aktive Erweiterungen kompakt zusammen.') + '</p>';
		}
		if (journeyNode) {
