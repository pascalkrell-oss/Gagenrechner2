(function () {
	...
	var DEFAULT_RESULT_MESSAGE = '<div class="sgk-default-state"><div class="sgk-default-price-label">Empfohlene Gage (Netto)</div><div class="sgk-default-price-value">0,00\u00a0€</div><div class="sgk-default-hint">Bitte Projekt wählen..<span>Alle Preise zzgl. MwSt.</span></div></div>';
	var LOADING_RESULT_MESSAGE = '<div class="sgk-default-state"><div style="width:32px;height:32px;border:3px solid rgba(255,255,255,0.15);border-top-color:#1a93ee;border-radius:50%;animation:sgk-spin 0.8s linear infinite;"></div><div class="sgk-default-price-label">Berechnung läuft...</div></div>';
	...
	function optionLabel(value) {
		var labels = { organic_branding: 'Organische Nutzung / Branding', paid_advertising: 'Paid-Kampagne', tv: 'TV', ctv: 'CTV', online_video: 'Online Video', kino: 'Kino', pos: 'POS', event: 'Event', messe: 'Messe', radio: 'Radio', online_audio: 'Online Audio', ladenfunk: 'Ladenfunk', ladenfunk_regional: 'Ladenfunk regional', telefon: 'Telefon', regional: 'Regional', lokal: 'Lokal', de: 'Deutschland', dach: 'DACH', eu: 'EU', weltweit: 'Weltweit', '1_jahr': '1 Jahr', '2_jahre': '2 Jahre', archiv: 'Archiv', unbegrenzt: 'Unbegrenzt', zeitlich_unbegrenzt: 'Zeitlich unbegrenzt' };
