	...
	function renderResult(container, payload, formData) {
		...
		container.innerHTML = '' +
			...
			'<div class="src-result-grid src-result-grid--stack">' +
				...
				'<section class="src-result-actions"><button type="button" class="src-btn-primary" data-sgk-action="open-pdf"><i class="fa-solid fa-file-signature" aria-hidden="true"></i> Angebot als PDF erstellen</button><div class="src-result-btn-grid"><button type="button" class="src-btn-secondary" data-label="Zusammenfassung kopieren" data-feedback-label="Zusammenfassung kopiert" data-sgk-action="copy-summary"><i class="fa-solid fa-align-left" aria-hidden="true"></i> Zusammenfassung kopieren</button><button type="button" class="src-btn-secondary" data-label="Einzelposten kopieren" data-feedback-label="Einzelposten kopiert" data-sgk-action="copy-positions"><i class="fa-solid fa-list-check" aria-hidden="true"></i> Einzelposten kopieren</button><button type="button" class="src-btn-secondary" data-label="Nutzungsrechte kopieren" data-feedback-label="Nutzungsrechte kopiert" data-sgk-action="copy-rights"><i class="fa-solid fa-scale-balanced" aria-hidden="true"></i> Nutzungsrechte kopieren</button><button type="button" class="src-btn-secondary" data-label="Alle Daten exportieren" data-feedback-label="Daten exportiert" data-sgk-action="copy-json"><i class="fa-solid fa-file-export" aria-hidden="true"></i> Alle Daten exportieren</button></div></section>' +
