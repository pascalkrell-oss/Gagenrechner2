...
<div class="sgk-app" data-sgk-app data-sgk-cases="<?php echo esc_attr( wp_json_encode( $cases ) ); ?>" data-sgk-ui-state="<?php echo esc_attr( wp_json_encode( $ui_state ) ); ?>">
	<header class="sgk-top-toolbar" aria-label="<?php esc_attr_e( 'Werkzeugleiste', 'sprecher-gagenrechner' ); ?>">
		<div class="sgk-toolbar-brand">
			<span class="sgk-toolbar-logo" aria-hidden="true"><i class="fa-solid fa-microphone-lines"></i></span>
		...
		<div class="sgk-toolbar-right">
			...
			<button type="button" class="sgk-toolbar-btn" data-sgk-action="save"><i class="fa-regular fa-floppy-disk" aria-hidden="true"></i><span><?php esc_html_e( 'Speichern', 'sprecher-gagenrechner' ); ?></span></button>
			<button type="button" class="sgk-toolbar-btn" data-sgk-action="load"><i class="fa-regular fa-folder-open" aria-hidden="true"></i><span><?php esc_html_e( 'Laden', 'sprecher-gagenrechner' ); ?></span></button>
			<button type="button" class="sgk-toolbar-btn" data-sgk-guide><i class="fa-regular fa-circle-question" aria-hidden="true"></i><span><?php esc_html_e( 'Anleitung', 'sprecher-gagenrechner' ); ?></span></button>
			<button type="button" class="sgk-toolbar-btn sgk-toolbar-btn--secondary" data-sgk-reset-calculator><i class="fa-solid fa-rotate-right" aria-hidden="true"></i><span><?php esc_html_e( 'Reset', 'sprecher-gagenrechner' ); ?></span></button>
		</div>
	</header>
			...
			<form class="sgk-form" data-sgk-form>
				...
				<section class="sgk-step-section" data-sgk-step="1">
					...
					<div class="sgk-project-grid" data-sgk-project-grid>
						<button type="button" class="sgk-project-card" data-sgk-case="werbung_mit_bild"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-display" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Werbung mit Bild', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'TV, Online Video, Kino', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="werbung_ohne_bild"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-volume-high" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Werbung ohne Bild', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Radio, Audio Ads', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="webvideo_imagefilm_praesentation_unpaid"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-regular fa-image" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Imagefilm / Webvideo', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Unpaid & Branding', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="telefonansage"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-phone-volume" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Telefonansage', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'IVR, Hotline, Warteschleife', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="elearning_audioguide"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-graduation-cap" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'E-Learning', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Lernmodule & Audioguide', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="podcast"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-microphone-lines" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Podcast', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Inhalt, Intro, Serienlizenz', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="hoerbuch"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-book-open" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Hörbuch', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'FAH-basierte Kalkulation', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="games"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-gamepad" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Games', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Session- und Studiotage', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="redaktionell_doku_tv_reportage"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-regular fa-newspaper" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Doku / Redaktion', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'TV, Kommentar, Overvoice', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="audiodeskription"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-ear-listen" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Audiodeskription', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Barrierefreie Auswertung', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="kleinraeumig"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-solid fa-location-dot" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Kleinräumige Nutzung', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Lokale bis regionale Einsätze', 'sprecher-gagenrechner' ); ?></span></button>
						<button type="button" class="sgk-project-card" data-sgk-case="session_fee"><span class="sgk-project-check"><i class="fa-solid fa-check" aria-hidden="true"></i></span><span class="sgk-card-icon"><i class="fa-regular fa-clock" aria-hidden="true"></i></span><span class="sgk-card-title"><?php esc_html_e( 'Session Fee', 'sprecher-gagenrechner' ); ?></span><span class="sgk-card-subtitle"><?php esc_html_e( 'Reine Studiozeit', 'sprecher-gagenrechner' ); ?></span></button>
					</div>
				...
				<section class="sgk-guidance-panel" data-sgk-expert-shell>
					<div class="sgk-step-header"><h2 class="sgk-step-title"><?php esc_html_e( 'Deine Auswahl', 'sprecher-gagenrechner' ); ?></h2></div>
				...
				<div class="sgk-actions-bar"><p class="sgk-validation-status" data-sgk-validation-status></p><button type="submit" class="sgk-btn-submit" data-sgk-submit disabled><?php esc_html_e( 'Bitte fülle noch aus', 'sprecher-gagenrechner' ); ?></button></div>
			</form>
		</aside>
