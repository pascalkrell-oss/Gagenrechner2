	...
	<div class="src-layout">
		<main class="src-config-engine" aria-labelledby="sgk-config-title">
			...
			<form class="sgk-form" data-sgk-form>
				...
				<section class="src-section" data-step="project">
					<div class="src-section-title-wrap">
						<p class="src-section-title">1. Projektart</p>
						<p class="src-section-copy"><?php esc_html_e( 'Wähle den Projekttyp. Die passenden Parameter und Optionen werden automatisch zusammengestellt.', 'sprecher-gagenrechner' ); ?></p>
					</div>
				...
				<section class="src-section is-disabled" data-step="usage" data-sgk-dependent-step>
					...
					<div class="src-panel-group" data-sgk-block="usage_type">
						<div class="src-panel-row src-panel-row--stack">
							<div class="src-row-content">
								...
								<div class="src-row-desc"><?php esc_html_e( 'Wir ordnen die Nutzung passend zur gewählten Ausspielung ein.', 'sprecher-gagenrechner' ); ?></div>
							</div>
							...
							<div class="src-segmented-control" data-sgk-usage-type-control>
								<button type="button" class="src-segment-btn" data-sgk-segment-value="organic_branding"><?php esc_html_e( 'Online / Branding', 'sprecher-gagenrechner' ); ?></button>
					...
					<div class="src-smart-hint" data-sgk-redirect-banner hidden>
						...
						<div>
							<strong><?php esc_html_e( 'Smart Match: Automatisch zugeordnet', 'sprecher-gagenrechner' ); ?></strong>
							<p><?php esc_html_e( 'Die Auswahl wurde passend zur optimalen Kalkulationsroute eingeordnet.', 'sprecher-gagenrechner' ); ?></p>
						</div>
					</div>
					<div class="src-panel-group" data-sgk-block="media_toggles">
						<label class="src-panel-row">
							<div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Paid Media', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Für bezahlte Ausspielung und Kampagnenreichweite.', 'sprecher-gagenrechner' ); ?></div></div>
							<span class="src-switch"><input type="checkbox" name="is_paid_media" value="1" /><span class="src-slider"></span></span>
						</label>
						<label class="src-panel-row">
							<div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Social Media', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Wenn Inhalte zusätzlich in sozialen Netzwerken ausgespielt werden.', 'sprecher-gagenrechner' ); ?></div></div>
							<span class="src-switch"><input type="checkbox" name="usage_social_media" value="1" /><span class="src-slider"></span></span>
						</label>
						<label class="src-panel-row">
							<div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Präsentation', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Für interne oder vertriebsnahe Präsentationsnutzung.', 'sprecher-gagenrechner' ); ?></div></div>
							<span class="src-switch"><input type="checkbox" name="usage_praesentation" value="1" /><span class="src-slider"></span></span>
						</label>
						<label class="src-panel-row">
							<div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Awardfilm', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Wird eingeblendet, wenn diese Nutzung in deinem Fall möglich ist.', 'sprecher-gagenrechner' ); ?></div></div>
							<span class="src-switch"><input type="checkbox" name="usage_awardfilm" value="1" /><span class="src-slider"></span></span>
						</label>
						<label class="src-panel-row">
							<div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Mitarbeiterfilm', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Für interne Filmnutzung innerhalb des Unternehmens.', 'sprecher-gagenrechner' ); ?></div></div>
				...
				<section class="src-section is-disabled" data-step="scope" data-sgk-dependent-step>
					...
					<div class="src-panel-group">
						...
						<div class="src-panel-row" data-sgk-block="recording_days"><div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Aufnahmetage', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Für wiederkehrende oder mehrtägige Sessions.', 'sprecher-gagenrechner' ); ?></div></div><div class="src-stepper" data-sgk-stepper><button type="button" data-sgk-step="down"><i data-lucide="minus" width="14" height="14"></i></button><input id="sgk-days" name="recording_days" type="number" min="1" step="1" value="1" /><button type="button" data-sgk-step="up"><i data-lucide="plus" width="14" height="14"></i></button></div></div>
						<div class="src-panel-row" data-sgk-block="same_day_projects"><div class="src-row-content"><div class="src-row-label"><?php esc_html_e( 'Weitere Projekte am selben Tag', 'sprecher-gagenrechner' ); ?></div><div class="src-row-desc"><?php esc_html_e( 'Hilft bei der Bewertung paralleler Sessions.', 'sprecher-gagenrechner' ); ?></div></div><div class="src-stepper" data-sgk-stepper><button type="button" data-sgk-step="down"><i data-lucide="minus" width="14" height="14"></i></button><input id="sgk-projects" name="same_day_projects" type="number" min="1" step="1" value="1" /><button type="button" data-sgk-step="up"><i data-lucide="plus" width="14" height="14"></i></button></div></div>
								...
								<div class="src-demo-shell">
									...
									<div class="src-grid-cards src-grid-cards--demo">
										<?php foreach ( $demo_cases as $demo ) : ?>
											<button type="button" class="src-card src-card--demo" data-sgk-demo='<?php echo esc_attr( wp_json_encode( $demo['input'] ) ); ?>'><span class="src-card-copy"><strong><?php echo esc_html( $demo['label'] ); ?></strong></span></button>
										<?php endforeach; ?>
									</div>
								</div>
							<?php endif; ?>
